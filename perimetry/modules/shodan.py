...
from perimetry.config.settings import API_KEYS
from perimetry.utils.util import  resolve_to_ip  , split_runner_args
...
=============================================
     Perimetry - Shodan Exposure Analyzer
=============================================
""")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Perimetry - Shodan Exposure Analyzer")
    parser.add_argument('inputs', nargs='+', help='IP addresses or domains to analyze')
    args = parser.parse_args()
    main(split_runner_args(args.inputs)[0])
