...
def banner():
    ...
    console.print("[cyan]       Perimetry – File Upload Surface Finder")
    console.print(f"[{TEAL}]{bar}")
...
def run(target, threads, opts):
    ...
    if EXPORT_SETTINGS.get("enable_txt_export"):
        ...
        write_to_file(os.path.join(out, "upload_surfaces.txt"), Console(record=True, file=io.StringIO()).export_text())
