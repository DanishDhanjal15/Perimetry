...
def banner():
    ...
    console.print("[cyan]   Perimetry - Rate‑Limit & WAF Bypass Test")
    console.print(f"[cyan]{bar}\n")
...
def run(target, threads, opts):
    ...
    if EXPORT_SETTINGS.get("enable_txt_export"):
        ...
        write_to_file(os.path.join(out, "rate_limit_waf_bypass.txt"), Console(record=True, file=io.StringIO()).export_text())
