...
from perimetry.utils.util import clean_domain_input, resolve_to_ip, ensure_directory_exists, write_to_file, render_to_text
...
def banner():
    ...
    console.print("[cyan]       Perimetry - NetBIOS Name Query")
    console.print(f"[#2EC4B6]{bar}\n")
...
def run(target, threads, opts):
    ...
    if EXPORT_SETTINGS.get("enable_txt_export"):
        ...
        write_to_file(os.path.join(out, "nbns_results.txt"), render_to_text(table, summary))
