...
from perimetry.utils.util import clean_url, ensure_directory_exists, write_to_file
from perimetry.config.settings import DEFAULT_TIMEOUT, EXPORT_SETTINGS, RESULTS_DIR, API_KEYS
...
def banner():
    ...
    console.print(f"[{TEAL}]   Perimetry - Performance Monitoring")
    console.print(f"[{TEAL}]{border}\n")
