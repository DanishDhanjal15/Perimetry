...
def scylla(domain):
    try:
        r=requests.get(f"https://scylla.sh/search?q=email:*@{domain}&size=100",timeout=30,headers={'User-Agent':'Perimetry'})
...
def main(target):
    banner="[bold green]=============================================[/bold green]\n[bold green]       Perimetry – Dark‑Web Monitor            [/bold green]\n[bold green]=============================================[/bold green]"
