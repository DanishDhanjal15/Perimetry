...
from perimetry.utils.util import clean_url, make_request, validate_url
...
def banner():
    ...
    =============================================
            Perimetry - CMS Enumeration Module
    =============================================
    """)
...
def enumerate_cms(target):
    try:
        ...
        if not response:
            console.print(Fore.RED + "[!] Error: No response from target (connection refused or dropped).")
            return None
