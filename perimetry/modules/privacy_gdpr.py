...
from perimetry.utils.util import clean_url, clean_domain_input, ensure_directory_exists, write_to_file, render_to_text
...
def banner():
    ...
    =============================================
          Perimetry – Privacy & GDPR Compliance
    =============================================
    """)
...
def run(target, threads, opts):
    ...
    if EXPORT_SETTINGS.get("enable_txt_export"):
        ...
        write_to_file(os.path.join(out, "privacy_gdpr.txt"), render_to_text(table, width=console.width))
