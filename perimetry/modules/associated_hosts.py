...
from perimetry.utils.util import resolve_to_ip, clean_domain_input, ensure_directory_exists, write_to_file, check_api_configured
...
def banner():
    ...
    console.print(f"[{TEAL}] Perimetry – Associated Hosts")
    console.print(f"[{TEAL}]{border}")
