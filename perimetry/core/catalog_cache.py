...
from perimetry.cli.catalog.loader import load as _load_raw
from perimetry.cli.catalog.model import (
...
ORIGINAL_AUTHOR = "Jason13"          # original Argus author
AUTHOR = "Danish Dhanjal"            # Perimetry fork maintainer
VERSION = "2.0"
