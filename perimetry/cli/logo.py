...
Version: [bold green]{version}[/bold green]    Modules: [bold yellow]{modules}[/bold yellow]
Original by [bold magenta]Jason13[/bold magenta]  ·  Fork extended by [bold magenta]{author}[/bold magenta]
""".strip()
    console.print(Panel(f"{colored}\n{desc}", border_style=TEAL, padding=(1, 2)), justify="center")
