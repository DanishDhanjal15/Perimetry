...
from perimetry.cli.helpers import resolve_module_number
...
class FavoritesMixin:
    ...
    def _fav_add(self, ident: str) -> None:
        ...
        console.print(f"Added [bold]{mod['name']}[/bold] to favorites.")
    ...
    def _fav_del(self, ident: str) -> None:
        ...
        try:
            ...
            console.print(f"Removed [bold]{mod['name']}[/bold] from favorites.")
        except KeyError:
